    ...
    <div>
      ...
      <form action={initTransaction}>
        ...
        <div>
          ...
          <TextInput id="shares" name="shares" required type="number" min={1} step={1} defaultValue={1} />         
        </div>
        <br />
        <div>
          <div className="mb-2 block">
          ...
          <TextInput id="price" name="price" required type="number" min={1} step={0.1} defaultValue={1} />         
        </div>
        <br />
